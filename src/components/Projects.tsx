...
const projects = [
  ...
  },
  {
    title: "GooDeals",
    description:
      <>Engineered a Gemini-powered platform to aggregate real-time deals, <span className="modern-highlighter">reducing user spend by 10%</span> and search time by 75% through high-speed Dockerized pipelines.</>,
    tags: ["Java", "Spring Boot", "React", "Tailwind CSS", "PostgreSQL", "Docker", "Gemini AI"],
    image: "/projects/goodeals.jpg",
    github: "https://www.github.com/hirtic-s/GooDeals"
  },
];
